...
<c:if
	test="${sessionScope.role_id == null && registerTeacherRole == null}">
...
<t:layout>
	<jsp:attribute name="title">
		...
		<c:if
			test="${createParam == null && editParam == null && displayParam == null && registerTeacherRole == null}">
			<title>Teachers</title>
		</c:if>
		<c:if
			test="${createParam == 'selected' && registerTeacherRole != null}">
				 ...
				 <c:if test="${sessionScope.role_id == 1}">
					...
					<form method="get" action="ServletTeacher">
						<button name="btnCreate" type="submit" value="create"
							...
							<h6 class="pt-1">Create Teacher</h6>
						</button>
					</form>
				</c:if>		
			</div>
			  ...
			  <c:forEach items="${teachers}" var="tec">
			      ...
			      <td>${tec.getTecFrst()} ${tec.getTecMid()} ${tec.getTecLast()}</td>
			      			      <td style="height: 150px;"><div
											class="scrollable custom-scrollbar">${tec.getTecAdd()}</div></td>
			      <td>${tec.getTecGen()}</td>
				      ...
				      <td>
				      	<form method="get" action="ServletTeacher" class="pt-3">
				      		<button name="btnEdit" type="submit"
													value="${tec.getTecId()}" class="btn btn-edit">
				      	...
				      	<form method="post" action="ServletTeacher" class="pt-2">
				      		<button name="postDelete" class="btn btn-delete"
													value="${tec.getTecId()}" type="submit">
	...
	<c:if test="${createParam == 'selected'}">
		<div class="container create-block px-0 my-5">
			<div class="container-fluid px-0"> 
				<c:if
						test="${registerTeacherRole != null || sessionScope.role_id == 1}">
					<h1 class="xbootstrap">Register Teacher</h1>
				</c:if>
				
				<c:if
						test="${registerTeacherRole == null && sessionScope.role_id == null}">
			...
			<div class="container py-5 w-50 form-container float-left">
				...
				<form method="post" action="ServletTeacher"
				  ...
				  <div class="form-row">
				    ...
				    <div class="form-group col-md-4">
				      ...
				      <input type="text" class="form-control" id="crTecFrst"
									name="crTecFrst">
				    </div>
				    
				    <div class="form-group col-md-4">
				      <label for="crTecMid">Middle Name</label>
				      <input type="text" class="form-control" id="crTecMid"
									name="crTecMid">
				    </div>
				    
				    <div class="form-group col-md-4">
				      <label for="crTecLast">Last Name</label>
				      <input type="text" class="form-control" id="crTecLast"
									name="crTecLast">
				    </div>
				  ...
				  <div class="form-row">
				    ...
				    <div class="form-group col-md-6">
				      ...
				      <input type="email" class="form-control" id="crTecMail"
									name="crTecMail">
				    </div>
				    ...
				    <div class="form-group col-md-6">
					  ...
					  <input type="password"
									class="form-control d-flex float-left tecPwdField"
									id="crTecPwd" name="crTecPwd">
					  <span class="pwdStatClass d-flex float-right mt-2"><i
									id="pwdIconTeacherCr" class="fas fa-eye"></i></span>
				    </div>
				  ...
				  <div class="form-row">
				    ...
				    <div class="form-group col-md-12">
				      ...
				      <textarea class="form-control" rows="5" id="crTecAdd"
									name="crTecAdd"></textarea>
				    </div>
				  ...
				  <div class="form-row">
				    ...
				    <div class="col-md-6 form-group">
						...
						<select id="crTecGen" name="crTecGen" class="form-control"
				      ...
				      <input type="date" class="form-control" id="crTecDob"
									name="crTecDob">
				    </div>
				  </div>
				  ...
				  <div class="form-row">
				    ...
				    <div class="form-group col-md-4">
				      ...
				      <input type="text" class="form-control" id="crTecCont"
									name="crTecCont">
				    </div>  
				    ...
				    <div class="form-group col-md-4">
				      ...
				      <input type="file" class="form-control d-none"
									onchange="showImageChoice(this)" id="crTecImg" name="crTecImg" /> 
				    </div>
				    
				    <div class="form-group col-md-4">
					  <label for="crTecHrs">Hours</label>
					  <input type="number" class="form-control" id="crTecHrs"
									name="crTecHrs">
					</div>	
				            ...
				            <div class="col-lg-4">
			                    <div class="member-card pt-2 pb-2">
			                        <div class="thumb-lg member-thumb mx-auto">
												...
												alt="teacher-image-on-create-form">
									</div>
								</div>
							</div>
						</div>
				   ...
				   <div class="form-row">
				    ...
				    <div class="form-group col-md-6">
				      ...
				      <select id="crTecDept" name="crTecDept" class="form-control">
				    ...
				    <div class="form-group col-md-6">
				      ...
				      <select id="crTecRole" name="crTecRole" class="form-control">
				      
				      	<option value="Select">Select</option>
			      		<c:forEach items="${roleNames}" var="roleN">					
							<option value='<c:out value="${roleN}" />'
				...
				<c:if test="${registerTeacherRole != null}">
					<button name="postCreate" value="create" type="submit"
								class="btn btn-create" formaction="${teacherRegisterServlet}">
						Create
					</button>
				</c:if>	
				</form>
			...
			<div class="container py-5 w-50 form-container float-left">
				...
				<div class="form-row">
				    ...
				    <div class="form-group col-md-4">
				      ...
				      <input type="text" class="form-control" id="upTecFrst"
									name="upTecFrst"
									value='<c:out value="${teacher.getTecFrst()}" />'>
				    </div>
				    
				    <div class="form-group col-md-4">
				      <label for="upTecMid">Middle Name</label>
				      <input type="text" class="form-control" id="upTecMid"
									name="upTecMid"
				    ...
				    <div class="form-group col-md-4">
				      ...
				      <input type="text" class="form-control" id="upTecLast"
									name="upTecLast"
									value='<c:out value="${teacher.getTecLast()}" />'>
				    </div>
				  </div>
				  ...
				  <div class="form-row">
				    <div class="form-group col-md-6">
				      ...
				      <input type="email" class="form-control" id="upTecMail"
									name="upTecMail"
									value='<c:out value="${teacher.getTecMail()}" />'>
				    </div>
				    ...
				    <div class="form-group col-md-6">
				      ...
				      <input type="password"
									class="form-control d-flex float-left tecPwdField"
									id="upTecPwd" name="upTecPwd"
									value='<c:out value="${teacher.getTecPwd()}" />'>
					  <span class="pwdStatClass d-flex float-right mt-2"><i
									id="pwdIconTeacherUp" class="fas fa-eye"></i></span>
				  ...
				  <div class="form-row">
				    ...
				    <div class="form-group col-md-12">
				      ...
				      <textarea class="form-control" rows="5" id="upTecAdd"
									name="upTecAdd"><c:out
				  ...
				  <div class="form-row">
				  	...
				  	<div class="col-md-6 form-group">
						...
						<select id="upTecGen" name="upTecGen" class="form-control"
									aria-label="Default select example">
						  <option value="Select"
										<c:if test='${teacher.getTecGen() == null}'><c:out value="selected" /></c:if>>
						  	Select
					  	  </option>
						  <option value="Male"
										<c:if test='${teacher.getTecGen() == "Male"}'><c:out value="selected" /></c:if>>
							Male
						 </option>
						 <option value="Female"
										<c:if test='${teacher.getTecGen() == "Female"}'><c:out value="selected" /></c:if>>
							Female
						 </option>
						  
						<option value="Transexual"
										<c:if test='${teacher.getTecGen() == "Transexual"}'><c:out value="selected" /></c:if>>
							Transexual
						 </option>
						 <option value="Bisexual"
										<c:if test='${teacher.getTecGen() == "Bisexual"}'><c:out value="selected" /></c:if>>
							Bisexual
						 </option>
						 <option value="Gay"
										<c:if test='${teacher.getTecGen() == "Gay"}'><c:out value="selected" /></c:if>>
							Gay
						 </option>
						 <option value="Lesbian"
										<c:if test='${teacher.getTecGen() == "Lesbian"}'><c:out value="selected" /></c:if>>
							Lesbian
						 </option>
						</select>
				  	</div>
				      ...
				      <input type="date" class="form-control" id="upTecDob"
									name="upTecDob"
									value='<c:out value="${teacher.getTecDob()}" />'>
				   	</div>
				  </div>
				  ...
				  <div class="form-row">
				    ...
				    <div class="form-group col-md-4">
				      ...
				      <input type="text" class="form-control" id="upTecCont"
									name="upTecCont"
									value='<c:out value="${teacher.getTecCont()}" />'>
				    </div>
				    ...
				    <div class="form-group col-md-4">
				      ...
				      <input type="file" class="form-control d-none"
									onchange="showImageChoice(this)" id="upTecImg" name="upTecImg" /> 
			        </div>
				    
				    <div class="form-group col-md-4">
				      <label for="upTecHrs">Hours</label>
				      <input type="number" class="form-control" id="upTecHrs"
									name="upTecHrs"
									value='<c:out value="${teacher.getTecHrs()}" />'>
				  	</div>
				  </div>
				  ...
				  <div id="upTecImgView" class="form-row" style="display: block;">
				    ...
				    <div
			            ...
			            <div class="col-lg-4">
		                    <div class="member-card pt-2 pb-2">
		                        <div class="thumb-lg member-thumb mx-auto">
											<img
												src="<c:url value='/resources/images/${teacher.getTecImg()}' />"
												class="rounded-circle img-thumbnail show-image"
												alt="teacher-image-on-edit-form">
								</div>
							</div>
						</div>
					</div>
				   ...
				   <div class="form-row">
				    <div class="form-group col-md-6">
				      ...
				      <select id="upTecDept" name="upTecDept" class="form-control">
				      	<option value="Select">Select</option>
				      	<c:forEach items="${depNames}" var="depUp">
				      		<option value='<c:out value="${depUp}" />'
											<c:if test="${serviceTeacher.getDepNameByDepId(teacher.getTecDept()) == depUp}">
				    ...
				    <div class="form-group col-md-6">
				      ...
				      <select id="upTecRole" name="upTecRole" class="form-control">
				      	<option value="Select">Select</option>
			      		<c:forEach items="${roleNames}" var="roleUp">
				      		<option value='<c:out value="${roleUp}" />'
											<c:if test="${serviceTeacher.getRoleNameByRoleId(teacher.getTecRole()) == roleUp}">
												<c:out value="selected" />
											</c:if>
				...
				<c:if test="${registerTeacherRole == null}">
				  <button name="postUpdate" value="${teacher.getTecId()}"
	...
	<c:if test="${displayParam == 'selected'}">
		<div class="container display-block px-0 my-5">
			<div
				...
				<c:if test="${sessionScope.role_id == null}">
					<form method="get" action="ServletTeacher">
						<button name="btnDisplay" type="submit" value="create"
				...
				<c:if test="${sessionScope.role_id != null}">
					<form method="get" action="../commonPages/ServletAdmin">
						<button name="btnView02" type="submit" value="create"
								class="btn btn-success ml-5">
				...
				<table class="table table-striped table-dark w-50 text-left mt-5">
				  <thead>
				    <tr class="text-center title-view bg-primary">
					  <th scope="row" colspan="2" class="pt-3"><h2>Teacher View</h2></th>
				    </tr>
				  </thead>
				  <tbody>
				  	<tr>
		            	<td colspan="2" class="text-center">
			            	<img
									src="<c:url value='/resources/images/${teacher.getTecImg()}' />"
									class="rounded-circle img-thumbnail show-image"
									alt="teacher-image-on-view-details" width="100" height="100">
						</td>
				  	</tr>
				  	<tr>
				      <td scope="col">Id</td>
				   ...
				   <c:if
								test="${sessionScope.role_id == 1 || sessionScope.teacher_id == teacher.getTecId()}">
				   	   <tr>
				    ...
				    <tr>
				      ...
				      <td style="height: 150px;"><div
										class="scrollable custom-scrollbar">${teacher.getTecAdd()}</div></td>
				    </tr>
				    <tr>
